...
class MoneyAddiction extends StatefulWidget {
  @override
  State<MoneyAddiction> createState() => _MoneyAddictionState();
}

class _MoneyAddictionState extends State<MoneyAddiction> {
